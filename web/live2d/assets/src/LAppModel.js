...
LAppModel.prototype.update = function()
{
    ...
    if (this.mainMotionManager.isFinished())
    {
        ...
        if(Sleepy === '1') {
            this.startRandomMotion(LAppDefine.MOTION_GROUP_SLEEP, LAppDefine.PRIORITY_SLEEP);
        }else {
    ...
    //-----------------------------------------------------------------		
    //if (this.mainMotionManager.isFinished()) {
    var Talking = sessionStorage.getItem('Talking');
    var talkflag;
        if (Talking === '1') {
            this.startRandomMotion(LAppDefine.MOTION_GROUP_TALK, LAppDefine.PRIORITY_TALK);
            talkflag = 1;
        } else {
            if (sessionStorage.getItem('stopTalking') === '1') {
                this.mainMotionManager.stopAllMotions();
                sessionStorage.setItem('stopTalking', '0');
